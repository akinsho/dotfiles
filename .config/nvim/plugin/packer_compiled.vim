...
local plugins = {
  ...
  vimwiki = {
    commands = { "VimwikiIndex", "ViwikiTabIndex" },
    loaded = false,
    only_sequence = false,
    only_setup = false,
...
" Command lazy-loads
command! -nargs=* -range -bang -complete=file ViwikiTabIndex call s:load(['vimwiki'], { "cmd": "ViwikiTabIndex", "l1": <line1>, "l2": <line2>, "bang": <q-bang>, "args": <q-args> })
