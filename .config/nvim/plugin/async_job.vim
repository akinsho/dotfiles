...
" Git commands
command! -count GitPush lua require'async_job'.exec('git push', <count>)
command! -count GitPull lua require'async_job'.exec('git pull', <count>)
command! -count GitStatus lua require'async_job'.exec('git status', <count>)
command! -count GitPushF lua require'async_job'.exec('git push -f', <count>)
