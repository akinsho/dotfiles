...
nnoremap <silent><leader>cr :CocCommand flutter.hotRestart<CR>
nnoremap <silent><leader>cl :CocCommand flutter.dev.openDevLog<CR>
...
if exists('*PluginLoaded') && PluginLoaded("vim-which-key")
  ...
  let g:which_leader_key_map.c.l = 'flutter: log'
  let g:which_leader_key_map.c.r = 'flutter: restart'
