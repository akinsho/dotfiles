...
syntax match NoSpellUri '\w\+:\/\/[^[:space:]]\+' contains=@NoSpell containedin=dartLineComment
syntax match NoSpellAcronym '\<\(\u\|\d\)\{3,}s\?\>' transparent  contains=@NoSpell containedin=dartLineComment,dart.*String
