...
syntax match NoSpellUri '\w\+:\/\/[^[:space:]]\+' contains=@NoSpell containedin=yaml.*Comment
syntax match NoSpellAcronym '\<\(\u\|\d\)\{3,}s\?\>' transparent  contains=@NoSpell containedin=yaml.*Comment,yaml.*String
