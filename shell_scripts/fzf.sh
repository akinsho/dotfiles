...
# Reference: Man fzf - bind previous and next history commands explicitly or
# they will swallow up c-n and c-p
export FZF_DEFAULT_OPTS="--history=$HOME/.fzf_history --bind up:previous-history down:next-history"
